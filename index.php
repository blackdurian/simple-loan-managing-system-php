    ...
    <div class="card-body">
      <div class="clearfix">
        ...
        <div class="float-right">
          ...
          <div class="fluid-container">
            <h3 class="font-weight-medium text-right mb-0">$12,131</h3>
          </div>
        </div>
      </div>
      <p class="text-muted mt-3 mb-0">
      ...
      <div class="card-body">
        ...
        <div class="row mt-3">
          <div class="col">
            ...
            <p class="graph-name text-center mt-2">New Loan Request</p>
          </div>
          <div class="col">
            ...
            <p class="graph-name text-center mt-2">New Loan Offer</p>
          </div>
        </div>
        ...
        <div class="row mt-3">   
          <div class = "col-xl-2 col-lg-3 col-md-3 col-sm-6 grid-margin">
            <a href="borr-lend-add.php?type=lender">
              <button  class="btn btn-squared-default-plain btn-primary">
                <i class="mdi mdi-account-box-outline icon-xl"></i>
                <br />Register
                <br />Leader
              </button>
            </a>     
          ...
          <div class = "col-xl-2 col-lg-3 col-md-3 col-sm-6 grid-margin">
            <a href="borr-lend-add.php?type=borrower">
              <button  class="btn btn-squared-default-plain btn-success">
                <i class="mdi mdi-account-circle icon-xl"></i>
                <br />
                Register
                <br />
                Borrower
