...
define(
  'tinymce.core.php.Node',
  [
    'global!tinymce.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('tinymce.php.Node');
  }
);
...
define(
  'tinymce.core.php.Writer',
  [
    'global!tinymce.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('tinymce.php.Writer');
  }
);
...
define(
  'tinymce.core.php.SaxParser',
  [
    'global!tinymce.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('tinymce.php.SaxParser');
  }
);
...
define(
  'tinymce.core.php.Schema',
  [
    'global!tinymce.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('tinymce.php.Schema');
  }
);
...
define(
  ...
  function (Mime, HtmlToData, UrlPatterns, VideoScript, UpdateHtml, Tools) {
    var dataToHtml = function (editor, dataIn) {
      ...
      if (!data.source1) {
        Tools.extend(data, HtmlToData .phpToData(editor.settings.media_scripts, data.embed));
        if (!data.source1) {
          return '';
        }
      }
  ...
  function (Delay, HtmlToData, UpdateHtml, Service, Size, Tools, Env, SizeManager) {
    ...
    var getData = function (editor) {
      ...
      return element.getAttribute('data-mce-object') ?
        HtmlToData .phpToData(editor.settings.media_scripts, editor.serializer.serialize(element, { selection: true })) :
        {};
    };
    ...
    var addEmbedHtml = function (win, editor) {
      return function (response) {
        ...
        var data = Tools.extend(HtmlToData .phpToData(editor.settings.media_scripts, html), { source1: response.url });
        win.fromJSON(data);
    ...
    var showDialog = function (editor) {
      ...
      var updateValueOnChange = function () {
        data = Tools.extend({}, HtmlToData .phpToData(editor.settings.media_scripts, this.value()));
